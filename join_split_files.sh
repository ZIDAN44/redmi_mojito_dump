...
cat vendor_bootimg/16_dtbdump_,M.* 2>/dev/null >> vendor_bootimg/16_dtbdump_,M
rm -f vendor_bootimg/16_dtbdump_,M.* 2>/dev/null
cat P.dtb.* 2>/dev/null >> P.dtb
rm -f P.dtb.* 2>/dev/null
